...
public class LC30_SubstringWithConcatenationOfAllWords {
    ...
    public static void main(String[] args) {
        LC30_SubstringWithConcatenationOfAllWords lc = new LC30_SubstringWithConcatenationOfAllWords();
        System.out.println(lc.findSubstring("barfoothefoobarman", new String[]{"foo","bar"}).toString());
    }
